...
bot = telebot.TeleBot('6930066381:AAFjXCW6cXBulnze1SYLCwUvxs5xLfoSoxA')
...
def webAppKeyboard(): #создание клавиатуры с webapp кнопкой
   ...
   one_butt = types.KeyboardButton(text="Тестовая игра дря разработки", web_app=webAppTest) #создаем кнопку типа webapp
   two_butt = types.KeyboardButton(text="Игра уже готова тест", web_app=webAppGame) #создаем кнопку типа webapp
...
def start_fun(message):
   bot.send_message( message.chat.id, 'Привет,Добро пожаловать к нам в проект STONIC)\nИспользуй кнопки меню в боте , чтобы перейти на страницу.', parse_mode="Markdown", reply_markup=webAppKeyboard()) #отправляем сообщение с нужной клавиатурой
